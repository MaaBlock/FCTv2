...
struct VertexAttribute {
    ...
    VertexAttribute(VertexAttributeType t, const std::string& n, DataType dt, size_t o)
...
public:
    ...
    void addAttribute(VertexAttributeType type, const std::string& name = "", DataType dataType = DataType::Float);
